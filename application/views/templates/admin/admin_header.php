...
<head>
  ...
  <script src="<?= base_url('assets/') ?>vendors/overlayscrollbars/OverlayScrollbars.min.js"></script>
  ...
  <link href="<?= base_url('assets/') ?>vendors/overlayscrollbars/OverlayScrollbars.min.css" rel="stylesheet">
